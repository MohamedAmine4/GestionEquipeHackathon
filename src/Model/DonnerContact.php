...
header("Access-Control-Allow-Origin: *"); // Permet à n'importe quel domaine d'accéder à cette ressource
header("Content-Type: application/json");

// Le reste de votre code PHP pour fournir les données JSON
